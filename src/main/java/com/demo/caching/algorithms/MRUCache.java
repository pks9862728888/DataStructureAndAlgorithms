...
/**
 * Evicts most recently used data
 * Useful in scenario in case you want to collect the least accessed data (but question is why use cache then?)
 */
public class MRUCache implements CacheInterface {
    ...
    public MRUCache(ExternalDataStore externalDataStore, int maxCacheSize) {
